...
+ (NSDictionary<NSString *, NSString *> *)A_PropertiesFromClass:(Class)cls {
	...
	A_Dictionary *propertyDictionary= [[A_Dictionary alloc] initWithCapacity:count];
...
+ (NSArray<NSString *> *)A_PropertieNamesFromClass:(Class)cls {
	return [[self A_PropertiesFromClass:cls] allKeys];
}
